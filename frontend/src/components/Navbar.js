                ...
                <div className="d-flex container">
                    ...
                    <div className="row col-sm align-self-center justify-content-end">
                        ...
                        }
                        {
                            !this.state.isLoggedIn && (
                                <div>
                                    <button onClick={this.handleLogin} type="button" class="btn btn-primary">Einloggen</button>
                                    <button onClick={this.handleRegister} type="button" class="btn btn-success ml-2">Registrieren</button>
                                </div>
                            )
                        }
                    </div>
